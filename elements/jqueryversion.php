...
class JElementJqueryversion extends JElement
{
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		$options[]	= JHtml::_('select.option', 'https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js', '1.9.1');
		$options[]	= JHtml::_('select.option', 'https://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js', '1.9.0');
		$options[]	= JHtml::_('select.option', 'https://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js', '1.8.3');
		$options[]	= JHtml::_('select.option', 'https://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js', '1.8.2');
		$options[]	= JHtml::_('select.option', 'https://ajax.googleapis.com/ajax/libs/jquery/1.8.1/jquery.min.js', '1.8.1');
		$options[]	= JHtml::_('select.option', 'https://ajax.googleapis.com/ajax/libs/jquery/1.8.0/jquery.min.js', '1.8.0');
		$options[]	= JHtml::_('select.option', 'https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js', '1.7.2');
